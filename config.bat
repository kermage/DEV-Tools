...
SET git_url=https://github.com/git-for-windows/git/releases/download/v2.13.1.windows.2/Git-2.13.1.2-32-bit.exe
SET node_url=https://nodejs.org/dist/v8.1.2/node-v8.1.2-x86.msi
