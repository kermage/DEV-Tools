...
POWERSHELL -Command "( gc %SCOOP%\persist\cmder\config\user_profile.sh ) -replace '###DEV_TOOLS###', '. ""%DEV_TOOLS%' | Out-File -encoding UTF8 %SCOOP%\persist\cmder\config\user_profile.sh"
