...
POWERSHELL -Command "( gc %SCOOP%\persist\cmder\config\user_profile.sh ) -replace '###DEV_TOOLS###', '. ""%DT_UNIX%' | Out-File -encoding ASCII %SCOOP%\persist\cmder\config\user_profile.sh"
